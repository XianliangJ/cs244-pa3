...
#define  EPOCH 50e3 // Verus epoch in microseconds, orig 5e3
#define  DELTA1 1.0 // delta decrease
#define  DELTA2 2.0 // delta increase
#define  VERUS_R 6.0 // verus ratio of Dmax/Dmin
#define	 SS_EXIT_THRESHOLD 200.0 // orig 500.0
#define  SS_INIT_TIMEOUT 600.0 // orig 1000.0
#define  MAX_TIMEOUT 600.0 // orig 1000.0
